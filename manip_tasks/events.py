...
def reset_robot_to_vertical_grasp_pose(
    ...
    # Quaternion [0, -1, 0, 0] for 180° rotation around Y-axis
    ...
    # This is a simplified approach - for UR10, we set joint angles
    # that result in a vertical end-effector pose
    joint_pos = robot.data.default_joint_pos.clone()
    joint_vel = robot.data.default_joint_vel.clone()

    # For UR10 with vertical grasp - target orientation Quat: [0, -1, 0, 0]
    ...
    joint_pos[env_ids, 4] = 1.57     # wrist_2: +90 degrees
